...
const Header = () => {
  ...
  return (
    <header 
      className={clsx("fixed top-0 left-0 w-full z-50 py-10 transition-all duration-500 max-lg:py-4", hasScrolled && "py-2 bg-black-100 backdrop-blur-[8px]",
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <ul 
              className="flex max-lg:block max-lg:px-12"
            >
              <li
                className="nav-li"
              >
              ...
              <li className="nav-logo">
                <LinkScroll
                  ...
                  spy
                  smooth
                  className={clsx("max-lg:hidden cursor-pointer transition-transform duration-500")}
                >
                  <img 
                    src="/images/xora.svg" 
                    alt="logo" 
